...
public class ColourGenerator
{
    ...
    public void UpdateElevation(MinMax elevationMinMax, Planet p)
    {
        p.mat.SetVector("_elevationMinMax", new Vector4(elevationMinMax.Min, elevationMinMax.Max));
    }
    ...
    public void UpdateColours(Planet p, ColourSettings settings)
    {
        ...
        texture.Apply();
        p.mat.SetTexture("_texture", texture);
    }
}
